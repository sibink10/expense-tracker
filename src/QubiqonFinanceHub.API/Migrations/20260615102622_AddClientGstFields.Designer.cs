...
namespace QubiqonFinanceHub.API.Migrations
{
    ...
    [Migration("20260615102622_AddClientGstFields")]
    partial class AddClientGstFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Auth.Shared.AuthSession", b =>
                {
                    ...
                    b.HasIndex("UserOid")
                        .HasDatabaseName("IX_auth_sessions_user_oid");

                    b.ToTable("auth_sessions", "dbo");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Account", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "ShortName")
                        .IsUnique();
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.ActivityComment", b =>
                {
                    ...
                    b.ToTable("ActivityComments", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.AdvancePayment", b =>
                {
                    ...
                    b.ToTable("AdvancePayments", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Client", b =>
                {
                    ...
                    b.Property<Guid?>("GstTreatmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GstTreatmentId");

                    b.HasIndex("OrganizationId");

                    b.HasIndex("PaymentTermsId");

                    b.HasIndex("PlaceOfSupplyCode");

                    b.ToTable("Clients", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.CodeSequence", b =>
                {
                    ...
                    b.ToTable("CodeSequences", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.EmployeeOrganizationContext", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("employee_organization_context", "dbo");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Forecast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("ExpectedExpenseDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("Forecasts", "finance");
                });

            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.GstTreatment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Invoice", b =>
                {
                    ...
                    b.Property<string>("ZohoSignRequestId")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("ZohoSignStatus")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<DateTime?>("ZohoSignStatusUpdatedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.OrganizationSetting", b =>
                {
                    ...
                    b.ToTable("OrganizationSettings", "dbo");
                });

            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.PaymentTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PaymentTerms", "finance");
                });

            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.PlaceOfSupply", b =>
                {
                    b.Property<string>("PlaceOfSupplyCode")
                        .HasMaxLength(2)
                        .IsUnicode(false)
                    ...
                    b.Property<string>("PlaceOfSupplyName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.HasKey("PlaceOfSupplyCode");

                    b.ToTable("PlaceOfSupply", "dbo");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.TaxConfiguration", b =>
                {
                    ...
                    b.ToTable("TaxConfigurations", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.VendorBillLineItem", b =>
                {
                    ...
                    b.ToTable("VendorBillLineItems", "finance");
                });
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.ActivityComment", b =>
                {
                    ...
                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.Forecast", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Client", b =>
                {
                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.GstTreatment", "GstTreatment")
                        .WithMany()
                        .HasForeignKey("GstTreatmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.PaymentTerm", "PaymentTerm")
                        .WithMany()
                        .HasForeignKey("PaymentTermsId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.PlaceOfSupply", "PlaceOfSupply")
                        .WithMany()
                        .HasForeignKey("PlaceOfSupplyCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("GstTreatment");
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.EmployeeOrganizationContext", b =>
                {
                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.Organization", "ActiveOrganization")
                        .WithMany()
                        .HasForeignKey("ActiveOrganizationId")
                        .HasConstraintName("FK_employee_org_ctx_organization");

                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.Employee", "Employee")
                        .WithOne("OrganizationContext")
                        .HasForeignKey("QubiqonFinanceHub.API.Models.Entities.EmployeeOrganizationContext", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.ExpenseRequest", b =>
                {
                    ...
                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.Forecast", "Forecast")
            ...
            modelBuilder.Entity("QubiqonFinanceHub.API.Models.Entities.Forecast", b =>
                {
                    b.HasOne("QubiqonFinanceHub.API.Models.Entities.Employee", "CreatedByEmployee")
                        .WithMany()
