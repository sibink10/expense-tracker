...
export const INIT_EXPENSES: Expense[] = [
  { id: "EXP-2026-00001", empId: 1, empName: "Arun Kumar", dept: "Engineering", amt: 15000, purpose: "Azure DevOps licenses", reqBy: "2026-03-20", status: EXP_S.PENDING, at: "2026-03-10", file: null, comments: [] },
  { id: "EXP-2026-00002", empId: 2, empName: "Priya Sharma", dept: "Marketing", amt: 45000, purpose: "Q1 LinkedIn Ads campaign", reqBy: "2026-03-25", status: EXP_S.APPROVED, at: "2026-03-08", file: null, comments: [{ by: "Rajesh Nair", text: "Approved.", d: "2026-03-09", t: "ok" }] },
  { id: "EXP-2026-00003", empId: 5, empName: "Vikram Menon", dept: "Sales", amt: 8500, purpose: "BLR-MUM client travel", reqBy: "2026-03-18", status: EXP_S.COMPLETED, at: "2026-03-07", file: { n: "travel.pdf", s: "128 KB" }, comments: [{ by: "Rajesh Nair", text: "Approved.", d: "2026-03-08", t: "ok" }, { by: "Meera Iyer", text: "Paid. Ref: QBQ0310001", d: "2026-03-10", t: "pay" }] },
];

export const INIT_BILLS: Bill[] = [
  { id: "BL-200/25-26", vId: "V001", vName: "The Ice Cream Factory", vGst: "32ADDPK7135J2ZN", vEmail: "accounts@icecreamfactory.in", amt: 449500, tds: "T07", tdsAmt: 8990, pay: 440510, desc: "Hoarding & LED displays — Infopark branding", bDate: "2026-03-10", due: "2026-04-09", terms: "net30", status: BILL_S.SUBMITTED, file: { n: "BL_200.pdf", s: "42 KB" }, by: 4, byName: "Meera Iyer", at: "2026-03-10", comments: [], cc: ["marketing@qubiqon.io"] },
  { id: "BL-201/25-26", vId: "V002", vName: "Azure Cloud Services", vGst: "27MSFTC1234A1Z5", vEmail: "billing@microsoft.com", amt: 285000, tds: "T07", tdsAmt: 5700, pay: 279300, desc: "Azure Feb 2026 subscription", bDate: "2026-03-05", due: "2026-04-04", terms: "net30", status: BILL_S.APPROVED, file: { n: "AZURE_FEB.pdf", s: "156 KB" }, by: 4, byName: "Meera Iyer", at: "2026-03-05", comments: [{ by: "Rajesh Nair", text: "Approved.", d: "2026-03-06", t: "ok" }], cc: [] },
];
